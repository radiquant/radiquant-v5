"""RadiMorphic result storage ORM models."""
...
class RadiMorphicResult(TimestampMixin, Base):
    """Tenant-scoped sensitive RadiMorphic result payload."""

    __tablename__ = "radimorphic_results"
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="radimorphic_results_schema_v1",
        ),
        CheckConstraint(
            "projection_status = 'pending_projection_builder'",
            name="radimorphic_results_projection_pending",
        ),
        Index("ix_radimorphic_results_tenant_run", "tenant_id", "module_run_id"),
    )
